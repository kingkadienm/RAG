...
import com.wangzs.rag.service.KnowledgeBaseService;
...
public class KnowledgeBaseController {
    ...
    public ApiResult<KnowledgeBase> getById(@PathVariable Long id) {
        KnowledgeBase kb = knowledgeBaseService.verifyOwnership(id);
    ...
    public ApiResult<KnowledgeBase> update(@PathVariable Long id,
        ...
        knowledgeBaseService.verifyOwnership(id);
    ...
    public ApiResult<Page<Document>> listDocuments(@PathVariable Long kbId,
                                            @RequestParam(name = "pageNum", defaultValue = "1") int pageNum,
                                            @RequestParam(name = "pageSize", defaultValue = "10") int pageSize) {
        knowledgeBaseService.verifyOwnership(kbId);
